...
try:
    while True:
        ...
        cv2.imwrite("./datasets/intel/" + str(name_common) + str(step_frames)+ "_original.jpg", color_image)
        cv2.imwrite("./datasets/intel/" + str(name_common) + str(step_frames)+ "_depth.png", depth_image)
